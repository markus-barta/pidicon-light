          ...
          <div class="scene-actions-card">
            <div class="scene-actions-card-main">
              ...
              <div class="scene-actions-card-text">
                ...
                <div class="scene-actions-card-help">Apply these settings to this scene on this device and keep them after restart.</div>
              </div>
            </div>
              ...
              <div class="scene-actions-card" style="margin-top:12px">
                <div class="scene-actions-card-main">
                  ...
                  <div class="scene-actions-card-text">
                    ...
                    <div class="scene-actions-card-help">Useful only if you want a new scene variant with its own file and settings.</div>
                  </div>
                </div>
