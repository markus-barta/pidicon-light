...
<body class="min-h-screen" x-data="app()" x-init="init()" x-cloak>
  ...
  <!-- Preview zoom -->
  <div x-show="showPreviewZoom" x-transition.opacity class="preview-lightbox" @click.self="closePreviewZoom()" @keydown.escape.window="closePreviewZoom()">
    <div class="preview-lightbox-panel">
      ...
      <div class="preview-lightbox-stage">
        <div class="preview-shell preview-shell-zoom" :style="previewZoomShellStyle()">
          <canvas class="preview-canvas"
